namespace ElGalio.Components
{
    ...
    internal class MyMenu
    {
        ...
        internal MyMenu()
        {
            RootMenu = new Menu("ElGalio", "ElGalio", true);
        ...
        {
            var node = new Menu("Orbwalker", "ElGalioorbwalker");
        ...
        {
            var node = new Menu("Target Selector", "ElGaliotargetselector");
